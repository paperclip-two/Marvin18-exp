...
public class RobotCentricAlign extends Command {
    ...
    private final int cameraID;
        ...
        public RobotCentricAlign(PhotonVision photon, CommandSwerveDrivetrain swerve, double holdDistance, int cameraID) {
            m_Vision = photon;
            m_Swerve = swerve;
            this.holdDistance = holdDistance;
            this.cameraID = cameraID;
        
        this.m_alignRequest = new SwerveRequest.RobotCentric().withDeadband(TunerConstants.kSpeedAt12Volts.baseUnitMagnitude() * 0.1).withRotationalDeadband(0.1);
        ...
        horizontalController = new ProfiledPIDController(HORIZONTAL_P, HORIZONTAL_I, HORIZONTAL_D, new TrapezoidProfile.Constraints(MAX_RANGE_VELOCITY, MAX_RANGE_ACCELERATION));
    ...
    public void execute() {
        ...
        Translation2d translation = new Translation2d(rangeOutput, horizontalOutput);
                
        m_Swerve.setControl(m_alignRequest
            .withVelocityX(translation.getX())
            .withVelocityY(translation.getY())
            .withRotationalRate(rotationOutput)); // offset
    }
